...
-- Generated at: 2026-09-24 18:57:55
...
-- Migration: 20260924000002_admin_edit_athlete.sql
-- ----------------------------------------
SELECT (NOT EXISTS (SELECT 1 FROM public._aspire_applied_migrations WHERE filename = '20260924000002_admin_edit_athlete.sql'))::text AS _run_mig \gset
\if :_run_mig
BEGIN;
-- ===========================================================================
...
INSERT INTO public._aspire_applied_migrations (filename) VALUES ('20260924000002_admin_edit_athlete.sql') ON CONFLICT (filename) DO NOTHING;
COMMIT;
\endif

-- Migration: 20260925000001_move_athlete_between_races.sql
-- ----------------------------------------
SELECT (NOT EXISTS (SELECT 1 FROM public._aspire_applied_migrations WHERE filename = '20260925000001_move_athlete_between_races.sql'))::text AS _run_mig \gset
\if :_run_mig
BEGIN;
...
INSERT INTO public._aspire_applied_migrations (filename) VALUES ('20260925000001_move_athlete_between_races.sql') ON CONFLICT (filename) DO NOTHING;
COMMIT;
\endif
